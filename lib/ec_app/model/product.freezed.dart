...
class _$_Product with DiagnosticableTreeMixin implements _Product {
  ...
  String toString({DiagnosticLevel minLevel = DiagnosticLevel.info}) {
    return 'Product(id: $id, name: $name, description: $description, price: $price, imagePath: $imagePath, stock: $stock, star: $star, reviewCount: $reviewCount)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, id, name, description, price,
      imagePath, stock, star, reviewCount);
...
abstract class _Product implements Product {
  const factory _Product(
      ...
      required final int reviewCount}) = _$_Product;
