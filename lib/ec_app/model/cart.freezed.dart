...
abstract class $CartCopyWith<$Res> {
  ...
  @useResult
  $Res call({List<CartItem> cartItemList});
}
...
class _$_Cart extends _Cart with DiagnosticableTreeMixin {
  _$_Cart({required final List<CartItem> cartItemList})
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ...
      ..add(DiagnosticsProperty('cartItemList', cartItemList));
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, const DeepCollectionEquality().hash(_cartItemList));
...
abstract class _Cart extends Cart {
  factory _Cart({required final List<CartItem> cartItemList}) = _$_Cart;
  _Cart._() : super._();
